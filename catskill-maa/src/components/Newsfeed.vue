...
const events = ref<Event[]>([
  {
    ...
    description: 'A night off for parents! Drop your kids off with us for a fun-filled evening of activities.',
    image: '/events/pno.jpg',
    category: 'special',
  },
  {
    id: 2,
  ...
  {
    id: 4,
    title: 'Bake and Yard Sale',
    date: '2026-05-23',
    time: 'TBA',
    location: 'East Broadway, Monticello, NY',
    description: 'Join us for our community bake and yard sale! Come support CMAA and find some great deals.',
    image: '/events/yardsale.jpg',
    category: 'community',
  },
  {
    id: 5,
    title: '49th Annual All Tang Soo Do Connecticut State Champions',
    date: '2026-05-30',
    time: 'TBA',
    location: 'David A. Beckerman Recreation Center, 300 Boston Post Rd, West Haven, CT 06516',
    description: 'The prestigious Connecticut State Tang Soo Do Championship — one of the longest-running tournaments in the region!',
    image: '/events/ctstate.jpg',
    category: 'tournament',
  },
  {
    id: 6,
    title: 'The Catalyst Cup',
    date: '2026-06-06',
    time: 'TBA',
    location: 'Red Hook, NY',
    description: 'An exciting tournament opportunity in Red Hook. All ranks and ages welcome to compete!',
    image: '/events/catalystcup.jpg',
    category: 'tournament',
  },
  {
    id: 7,
    ...
    date: '2026-06-13',
    time: 'TBA',
    location: 'Our Lady of Good Counsel, 701 W. Main St, Endicott, NY',
